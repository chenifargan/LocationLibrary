...
import com.example.maplocationpicker.LocationPickerActivity;
import com.example.maplocationpicker.MapUtility;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MapUtility.apiKey = "AIzaSyCPjpOvAE6sSd15N4yEQf28GAtUeywFL98";
        findViewById(R.id.btnAddressPicker).setOnClickListener(MainActivity.this);
